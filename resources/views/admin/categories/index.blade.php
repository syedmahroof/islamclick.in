...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h2 class="text-2xl font-light text-gray-900">Categories</h2>
        <a href="{{ route('admin.categories.create') }}" class="bg-[#bd9966] hover:bg-[#a88455] text-white font-medium py-2 px-6 rounded-md transition">
            + Add Category
        </a>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <a href="{{ route('admin.categories.edit', $category) }}" class="text-[#bd9966] hover:text-[#a88455] mr-4">Edit</a>
